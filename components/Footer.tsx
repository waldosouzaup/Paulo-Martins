...
export const Footer: React.FC = () => {
  ...
  const displayWhatsapp = trackingSettings?.whatsapp_number ? formatPhoneNumber(trackingSettings.whatsapp_number) : '+55 (61) 9 9117-6958';
  const instagramLink = trackingSettings?.instagram_link && trackingSettings.instagram_link !== '#' ? trackingSettings.instagram_link : 'https://www.instagram.com/paulomartins_imoveis/';
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 text-sm text-gray-400 mb-6">
              <li>Brasília, DF</li>
              <li><a href={`https://wa.me/${rawWhatsapp}`} target="_blank" rel="noopener noreferrer" className="hover:text-gold-400 transition-colors">{displayWhatsapp}</a></li>
            </ul>
            <div className="flex gap-4">
               <a href={`https://wa.me/${rawWhatsapp}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gold-400 hover:bg-gold-600 hover:text-white transition-all">
               ...
               <a href={instagramLink} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gold-400 hover:bg-gold-600 hover:text-white transition-all"><Instagram size={18} /></a>
            </div>
          </div>
        </div>
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-600">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              id="admin-footer-lock"
              to="/admin/dashboard"
              className="text-gray-800 hover:text-gold-500/30 hover:scale-105 transition-all duration-300"
              title="Restrito"
            >
              <Lock size={12} />
            </Link>
